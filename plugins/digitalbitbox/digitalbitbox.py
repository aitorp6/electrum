...
try:
    ...
    from electrum_deeponion.crypto import Hash, EncodeAES, DecodeAES
    from electrum_deeponion.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh, is_address,
                                  serialize_xpub, deserialize_xpub)
    from electrum_deeponion import ecc
    from electrum_deeponion.ecc import msg_magic
