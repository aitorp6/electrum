...
from electrum_deeponion.util import PrintError, UserCancelled
from electrum_deeponion.keystore import bip39_normalize_passphrase
from electrum_deeponion.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the onions in the wallet.").format(self.device)
        else:
