...
from electrum_deeponion.util import format_satoshis, set_verbosity
from electrum_deeponion.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-deeponion create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-deeponion setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-deeponion setconfig' to change your settings")
        return True
