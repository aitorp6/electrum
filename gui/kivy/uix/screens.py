...
from electrum_deeponion.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_deeponion import bitcoin
from electrum_deeponion.util import timestamp_to_datetime
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        if not self.app.wallet:
            ...
            return
        import electrum_deeponion
        try:
            uri = electrum.util.parse_URI(text, self.app.on_pr)
        except:
            self.app.show_info(_("Not a Deeponion URI"))
            return
    ...
    def do_save(self):
        ...
        from electrum_deeponion.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_deeponion.util import create_URI
    ...
    def do_share(self):
        uri = self.get_URI()
        self.app.do_share(uri, _("Share Deeponion Request"))
